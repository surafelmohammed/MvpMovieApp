...
public class TopAdapter$ViewHolder_ViewBinding implements Unbinder {
  private TopAdapter.ViewHolder target;

  @UiThread
  public TopAdapter$ViewHolder_ViewBinding(TopAdapter.ViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TopAdapter.ViewHolder target = this.target;
